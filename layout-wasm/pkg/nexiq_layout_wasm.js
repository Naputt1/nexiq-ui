/* @ts-self-types="./nexiq_layout_wasm.d.ts" */
...
export class ForceLayout {
    ...
    get_positions(out) {
        ...
        wasm.forcelayout_get_positions(this.__wbg_ptr, ptr0, len0, out);
    }
    /**
     ...
     * @param {any} options
     */
    constructor(positions, radii, fixed, sources, targets, options) {
        const ptr0 = passArrayF32ToWasm0(positions, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayF32ToWasm0(radii, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArray8ToWasm0(fixed, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passArray32ToWasm0(sources, wasm.__wbindgen_malloc);
        const len3 = WASM_VECTOR_LEN;
        const ptr4 = passArray32ToWasm0(targets, wasm.__wbindgen_malloc);
        const len4 = WASM_VECTOR_LEN;
        const ret = wasm.forcelayout_new(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, options);
        if (ret[2]) {
     ...
     */
    run_steps(count) {
        wasm.forcelayout_run_steps(this.__wbg_ptr, count);
    }
    step() {
        wasm.forcelayout_step(this.__wbg_ptr);
    }
}
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./nexiq_layout_wasm_bg.js": import0,
    };
}

const ForceLayoutFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_forcelayout_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('nexiq_layout_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
